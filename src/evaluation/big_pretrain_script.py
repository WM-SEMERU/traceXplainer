...
def generate_model(corpus, vocab_size, vector_size=100, min_count=2, epochs=50, model_type='sg'):
    ...
    if model_type == 'sg':
        ...
        word2vec_model.save("w2v_sg_vectorSize{}_minCount{}_BPEvocabSize{}".format(vector_size, min_count, vocab_size))
        ...
        # add code to save model here 
        word2vec_model.save("w2v_cbow_vectorSize{}_minCount{}_BPEvocabSize{}".format(vector_size, min_count, vocab_size))
        ...
        # add code to save model here 
        doc2vec_model.save("d2v_vectorSize{}_minCount{}_BPEvocabSize{}".format(vector_size, min_count, vocab_size))
