...
def dronology_params():
    ...
    return {
        ...
        'linkType': 'req2src',
        'path_to_trained_model': '../dvc-data/systems/dronology/2vec_models/bpe32k/word2vec/word2vec_bpe32k_java_py.model',
        'source_type': 'req',
        'target_type': 'code',
        'system_path_config': {
            ...
            'names': ['ids', 'bpe8k'],
            "bpe_model_path": '../dvc-data/systems/dronology/bpe_models/java_py_bpe32k.model'
        },
