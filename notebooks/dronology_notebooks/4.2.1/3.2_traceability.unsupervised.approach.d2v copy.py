...
SEP = '~'
MODEL_PATH = '../dvc-data/systems/dronology/2vec_models/conv_wiki/doc2vec/doc2vec_conv_java_py_wiki.model'
MAPPING_CSV = '../dvc-data/systems/dronology/mappings/conventional.csv'
OUTPUT_DIR = '../dvc-data/systems/dronology/experiment4.2.1/results/'
INFER_STEPS = 200
